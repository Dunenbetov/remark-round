...
export interface TriageGold {
  ...
  /**
   * Раздел-опора кейса («§2.1» или подпись раздела без номера, например «Решения, которых нет в ТЗ»):
   * по нему считается hit@1/3/6 поиска; у дефекта он ещё и обязан быть среди цитат (binding).
   */
  section?: string;
