...
const ICONS: Record<IconName, string> = {
  ...
  /* колокольчик приглашений и «отправить ссылку» (ADR 013): без логотипов мессенджеров — самолётик и облачко */
  bell: 'M6 9a6 6 0 0 1 12 0c0 6.5 2.5 8 2.5 8h-17S6 15.5 6 9M10.3 20.5a2 2 0 0 0 3.4 0',
  ...
  message: 'M20.5 11.5a8.5 8.5 0 0 1-12.4 7.6L3.5 20.5l1.4-4.4A8.5 8.5 0 1 1 20.5 11.5z',
  share: 'M12 14V3m-4 4 4-4 4 4M5 11v8.5A1.5 1.5 0 0 0 6.5 21h11a1.5 1.5 0 0 0 1.5-1.5V11',
};
