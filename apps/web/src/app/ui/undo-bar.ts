 ...
 * Полоска-таймер и цифра 5…1 маркером `--rr-accent-2` (закон маркера: на индиго — белый). Уход плавный: держим копию последнего pending
...
@Component({
  ...
  styles: `
    ...
    /* цифра отсчёта — белый маркер, 18/600, рядом с «Отменить» */
    .undo__sec {
      flex: none;
      min-width: 1ch;
      font-size: var(--fs-18);
