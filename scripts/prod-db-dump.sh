#!/bin/sh
# Копия боевой базы на локальную машину.
# Встроенные бэкапы Railway есть только на Pro, внешнего хранилища пока нет, а с 21.09 в базе
# рабочие данные команды. Поэтому минимум: раз в неделю и перед каждым merge с миграцией делаем pg_dump сюда.
#
