...
|---|---|---|---|
| Журнал | 4 | 6 | 6 |
| Карточка (light + dark) | 5 | 5 | 5 |
| Очередь разработчика | 5 | 5 | 5 |
