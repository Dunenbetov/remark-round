...
|---|---|---|---|---|
| Журнал | 4 | 6 | 6 | 6.5 |
| Карточка (light + dark) | 5 | 5 | 5 | 6.5 |
| Очередь разработчика | 5 | 5 | 5 | 7 |

r4 снят после закрытия списка r3 (таблица «Раунд 4» ниже); его замечания тоже разобраны — отсюда вторая правка того же дня.
